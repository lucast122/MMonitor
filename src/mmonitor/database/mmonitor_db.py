...
class MMonitorDBInterface:
    ...
    def update_table_with_kraken_out(self, kraken_out_path: str, tax_rank: str, sample_name: str, project_name: str) -> str:
        con = sqlite3.connect(self._db_path)
        cursor = con.cursor()
...
# i = MMonitorDBInterface("/resources/mmonitor_centrifuge_test.db")
# i.create_db('/Users/timolucas/PycharmProjects/MMonitor/src/mmonitor/resources/mmonitor_centrifuge_test.db')
# i.update_table_with_kraken_out('/Users/timolucas/PycharmProjects/MMonitor/src/mmonitor/userside/classifier_out/test_kraken_out','S','9','test_project')
