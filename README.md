...
For more detailed usage instructions visit [mmonitor.org](www.mmonitor.org)
...
Taxonomy: View your samples' absolute and relative abundances after running a taxonomic analysis.
Horizon plot: Create a horizon plot to see changes in abundance between your samples quickly.
Correlations: Add metadata to view different correlation values between metagenome abundances and the metadata.
Diversity: Common metrics like alpha and beta diversity of your samples.
QC: Sequence quality statistic plots
