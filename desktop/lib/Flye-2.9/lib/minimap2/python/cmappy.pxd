...
cdef extern from "minimap.h":
    ...
    int mm_gen_cs(void *km, char ** buf, int *max_len, const mm_idx_t *mi, const mm_reg1_t *r, const char *seq,
                  int no_iden)
...
cdef extern from "cmappy.h":
    ...
    mm_reg1_t *mm_map_aux(const mm_idx_t *mi, const char *seq1, const char *seq2, int *n_regs, mm_tbuf_t *b,
